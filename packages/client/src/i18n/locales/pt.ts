export default {
  ...
  chat: {
    ...
    archive: 'Arquivar',
    unarchive: 'Restaurar',
    sessionArchived: 'Sessao arquivada',
    sessionUnarchived: 'Sessao restaurada',
    ...
    workspaceDiffTitle: 'Alterações do workspace',
    workspaceDiffLoadFailed: 'Falha ao carregar o patch',
    ...
    modelFamilySwitchNotice: 'Trocar de família de modelos redefine o contexto de raciocínio anterior; a primeira resposta pode demorar um pouco mais.',
...
jobTriggered: 'Job acionado',
  ...
  models: {
    ...
    capabilityVision: 'Visão — este modelo pode ler imagens',
    capabilityReasoning: 'Raciocínio — este modelo pensa antes de responder',
    defaultModelTooltip: 'Modelo padrão deste perfil',
  ...
  profiles: {
    ...
    share: {
      ...
      grantee: 'Email ou Feishu user_id',
      role: 'Role',
      grant: 'Grant',
      revoke: 'Revoke',
  ...
  settings: {
    ...
    display: {
      ...
      chatInputHeightHint: 'Altura do compositor desktop em pixels. No mobile continua automatica.',
  ...
  files: {
    ...
    previewFileTab: 'Arquivo',
    previewDiffTab: 'Alterações desta execução',
    diffPatchTruncated: 'O patch é muito grande e foi truncado — alterne para "Arquivo" para ver o conteúdo completo',
    previewContentUnavailable: 'Falha ao carregar o conteúdo do arquivo — ele pode ter sido excluído ou movido; as alterações da execução continuam visíveis',
