export default {
  ...
  chat: {
    ...
    archive: 'Archiver',
    unarchive: 'Restaurer',
    sessionArchived: 'Session archivee',
    sessionUnarchived: 'Session restauree',
    archiveFailed: 'Echec de l archivage',
    unarchiveFailed: 'Echec de la restauration',
    rename: 'Renommer',
    pin: 'Épingler',
    unpin: 'Désépingler',
    pinned: 'Épinglés',
    ...
    workspaceDiffTitle: 'Modifications du workspace',
    workspaceDiffLoadFailed: 'Échec du chargement du patch',
    ...
    modelFamilySwitchNotice: 'Changer de famille de modèles réinitialise le contexte de raisonnement précédent ; la première réponse peut être un peu plus lente.',
...
jobTriggered: 'Job declenche',
  ...
  models: {
    ...
    capabilityVision: 'Vision — ce modèle peut lire des images',
    capabilityReasoning: 'Raisonnement — ce modèle réfléchit avant de répondre',
    defaultModelTooltip: 'Modèle par défaut de ce profil',
  ...
  profiles: {
    ...
    share: {
      ...
      grantee: 'E-mail ou Feishu user_id',
      role: 'Role',
      grant: 'Grant',
      revoke: 'Revoke',
      loadFailed: 'Failed to load shared members',
      grantSuccess: 'Share granted',
      grantFailed: 'Failed to grant share',
  ...
  settings: {
    ...
    display: {
      ...
      chatInputHeightHint: 'Hauteur du composeur desktop en pixels. Le mobile reste automatique.',
  ...
  files: {
    ...
    previewFileTab: 'Fichier',
    previewDiffTab: 'Modifications de cette exécution',
    diffPatchTruncated: 'Le correctif est trop volumineux et a été tronqué — passez à « Fichier » pour afficher le contenu complet',
    previewContentUnavailable: "Impossible de charger le contenu du fichier — il a peut-être été supprimé ou déplacé ; les modifications de l'exécution restent consultables",
