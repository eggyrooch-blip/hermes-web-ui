export default {
  ...
  chat: {
    ...
    workspaceDiffTitle: 'Workspace 변경',
    workspaceDiffLoadFailed: '패치 로드 실패',
    ...
    modelFamilySwitchNotice: '모델 계열을 변경하면 이전 추론 컨텍스트가 초기화되어 첫 응답이 다소 느려질 수 있습니다.',
  ...
  models: {
    ...
    capabilityVision: '비전 — 이미지를 인식할 수 있습니다',
    capabilityReasoning: '추론 — 답변 전에 사고합니다',
    defaultModelTooltip: '이 프로필의 기본 모델',
  ...
  settings: {
    ...
    display: {
      ...
      chatInputHeightHint: '데스크톱 입력창 높이(px)입니다. 모바일은 자동 높이를 유지합니다.',
