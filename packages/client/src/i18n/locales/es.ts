export default {
  ...
  login: {
    ...
    lockResetHint: 'Si este es tu servidor, borra el bloqueo de inicio de sesion con:',
    defaultLoginResetHint: 'Para restablecer la contrasena admin predeterminada, ejecuta:',
...
jobTriggered: 'Job ejecutado',
  ...
  settings: {
    ...
    display: {
      ...
      themeSystem: 'Sistema',
      style: 'Estilo',
      styleHint: 'Elige la interfaz de tinta estándar o el estilo comic',
      styleInk: 'Tinta',
      styleComic: 'Comic',
    },
    agent: {
