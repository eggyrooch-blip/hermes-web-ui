export default {
  ...
  chat: {
    ...
    archive: 'Archivar',
    unarchive: 'Restaurar',
    sessionArchived: 'Sesion archivada',
    sessionUnarchived: 'Sesion restaurada',
    archiveFailed: 'Error al archivar',
    unarchiveFailed: 'Error al restaurar',
    rename: 'Renombrar',
    pin: 'Fijar',
    unpin: 'Desfijar',
    pinned: 'Fijados',
    ...
    workspaceDiffTitle: 'Cambios del workspace',
    workspaceDiffLoadFailed: 'No se pudo cargar el parche',
    ...
    modelFamilySwitchNotice: 'Cambiar de familia de modelos reinicia el contexto de razonamiento anterior; la primera respuesta puede tardar un poco más.',
...
jobTriggered: 'Job ejecutado',
  ...
  models: {
    ...
    capabilityVision: 'Visión: este modelo puede leer imágenes',
    capabilityReasoning: 'Razonamiento: este modelo piensa antes de responder',
    defaultModelTooltip: 'Modelo predeterminado de este perfil',
  ...
  profiles: {
    ...
    share: {
      ...
      grantee: 'Correo o Feishu user_id',
      role: 'Role',
      grant: 'Grant',
      revoke: 'Revoke',
  ...
  settings: {
    ...
    display: {
      ...
      chatInputHeightHint: 'Altura del compositor de escritorio en pixeles. En movil sigue automatica.',
  ...
  files: {
    ...
    closePreview: 'Cerrar',
    previewRender: 'Renderizar',
    previewSource: 'Código',
    previewFileTab: 'Archivo',
    previewDiffTab: 'Cambios de esta ejecución',
    diffPatchTruncated: 'El parche es demasiado grande y se ha truncado; cambia a «Archivo» para ver el contenido completo',
    previewContentUnavailable: 'No se pudo cargar el contenido del archivo: puede haber sido eliminado o movido; los cambios de la ejecución siguen visibles',
