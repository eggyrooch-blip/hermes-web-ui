export default {
  ...
  chat: {
    ...
    sessionUnarchived: '工作階段已復原',
    archiveFailed: '封存失敗',
    unarchiveFailed: '復原失敗',
    rename: '重新命名',
    pin: '釘選',
    unpin: '取消釘選',
    pinned: '已釘選',
    ...
    workspaceDiffTitle: '工作區改動',
    workspaceDiffLoadFailed: '補丁載入失敗',
    ...
    modelSet: '模型已設定',
    modelFamilySwitchNotice: '切換模型系列後，歷史推理脈絡會重置，第一則回覆可能稍慢',
  ...
  models: {
    ...
    capabilityVision: '視覺 — 可辨識圖片',
    capabilityReasoning: '推理 — 回答前會先思考',
    defaultModelTooltip: '目前 profile 的預設模型',
  ...
  settings: {
    ...
    display: {
      ...
      compact: '緊湊模式',
      compactHint: '減少訊息間距',
      chatInputHeight: '輸入框高度',
      chatInputHeightHint: '桌面端輸入框高度（像素），行動端保持自適應。',
