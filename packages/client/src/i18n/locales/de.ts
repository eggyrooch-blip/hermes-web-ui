export default {
  ...
  chat: {
    ...
    sessionUnarchived: 'Sitzung wiederhergestellt',
    ...
    workspaceDiffTitle: 'Workspace-Änderungen',
    workspaceDiffLoadFailed: 'Patch konnte nicht geladen werden',
    ...
    modelFamilySwitchNotice: 'Ein Wechsel der Modellfamilie setzt den bisherigen Reasoning-Kontext zurück; die erste Antwort kann etwas länger dauern.',
...
jobTriggered: 'Job ausgelost',
  ...
  models: {
    ...
    capabilityVision: 'Vision — dieses Modell kann Bilder lesen',
    capabilityReasoning: 'Reasoning — dieses Modell denkt vor der Antwort nach',
    defaultModelTooltip: 'Standardmodell dieses Profils',
  ...
  profiles: {
    ...
    share: {
      ...
      grantee: 'E-Mail oder Feishu user_id',
      role: 'Role',
      grant: 'Grant',
      revoke: 'Revoke',
  ...
  settings: {
    ...
    display: {
      ...
      chatInputHeight: 'Chat-Eingabehoehe',
      chatInputHeightHint: 'Hoehe des Desktop-Composers in Pixeln. Mobil bleibt Auto-Hoehe.',
  ...
  files: {
    ...
    previewRender: 'Rendern',
    previewSource: 'Quelltext',
    previewFileTab: 'Datei',
    previewDiffTab: 'Änderungen dieses Laufs',
    diffPatchTruncated: 'Der Patch ist zu groß und wurde abgeschnitten — wechseln Sie zu „Datei“, um den vollständigen Inhalt anzuzeigen',
    previewContentUnavailable: 'Dateiinhalt konnte nicht geladen werden – die Datei wurde möglicherweise gelöscht oder verschoben; die Änderungen des Laufs bleiben einsehbar',
