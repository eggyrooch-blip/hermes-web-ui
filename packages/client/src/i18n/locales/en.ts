export default {
  ...
  profiles: {
    ...
    rolePresetCoder: 'Coder',
    rolePresetResearcher: 'Researcher',
    rolePresetWriter: 'Writer',
    rolePresetOperator: 'Operator',
    rolePresetCustom: 'Custom',
    roleDescription: 'Role description',
    roleDescriptionPlaceholder: 'Describe this profile role',
    rolePresetCoderDescription: 'Software engineering agent for coding, debugging, tests, repo navigation, and pull request work.',
    rolePresetResearcherDescription: 'Research agent for web/source investigation, synthesis, citations, and structured reports.',
    rolePresetWriterDescription: 'Writing agent for drafts, editing, summaries, proposals, and polished long-form documents.',
    rolePresetOperatorDescription: 'Operations agent for recurring tasks, Feishu/workflow execution, checklists, and status tracking.',
