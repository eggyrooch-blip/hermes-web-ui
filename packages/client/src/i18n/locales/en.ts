export default {
  ...
  chat: {
    ...
    reauthKicker: 'Re-authorization needed',
    reauthTitle: 'A connection needs re-authorization',
    reauthDesc: '{connector} credentials expired. Re-authorize to continue this request automatically.',
    reauthAction: 'Authorize {connector}',
    reauthRetrying: 'Re-running…',
    newCliChat: 'New CLI',
    ...
    sessionUnarchived: 'Session restored',
    archiveFailed: 'Archive failed',
    unarchiveFailed: 'Restore failed',
    rename: 'Rename',
    pin: 'Pin',
    unpin: 'Unpin',
    pinned: 'Pinned',
    ...
    modelSet: 'Model set',
    modelFamilySwitchNotice: 'Switching model families resets the reasoning context from earlier turns; the first reply may be a little slower.',
    ...
    workspaceDiffTitle: 'Workspace changes',
    workspaceDiffLoadFailed: 'Failed to load patch',
  ...
  models: {
    ...
    capabilityVision: 'Vision — this model can read images',
    capabilityReasoning: 'Reasoning — this model thinks before answering',
    defaultModelTooltip: 'Default model for this profile',
  ...
  settings: {
    ...
    display: {
      ...
      chatInputHeightHint: 'Desktop composer height in pixels. Mobile keeps auto-height.',
  ...
  files: {
    ...
    diffPatchEmpty: 'No text patch to show for this change (possibly a binary file or a rename)',
    saveFile: 'Save',
  },
  // Download
  download: {
