export default {
  ...
  chat: {
    ...
    sessionUnarchived: 'セッションを復元しました',
    archiveFailed: 'アーカイブに失敗しました',
    unarchiveFailed: '復元に失敗しました',
    rename: '名前変更',
    pin: 'ピン留め',
    unpin: 'ピン留め解除',
    pinned: 'ピン留め',
    ...
    workspaceDiffTitle: 'Workspace の変更',
    workspaceDiffLoadFailed: 'パッチの読み込みに失敗しました',
    ...
    modelSet: 'モデルを設定しました',
    modelFamilySwitchNotice: 'モデル系列を切り替えると、これまでの推論コンテキストがリセットされ、最初の応答が少し遅くなることがあります。',
  ...
  models: {
    ...
    capabilityVision: 'ビジョン — 画像を読み取れます',
    capabilityReasoning: '推論 — 回答前に思考します',
    defaultModelTooltip: 'このプロファイルの既定モデル',
  ...
  settings: {
    ...
    display: {
      ...
      chatInputHeight: 'チャット入力の高さ',
      chatInputHeightHint: 'デスクトップ入力欄の高さ（px）。モバイルは自動調整のままです。',
