export default {
  ...
  chat: {
    ...
    clarifyDismiss: '忽略',
    reauthKicker: '需要重新授权',
    reauthTitle: '有一个连接需要重新授权',
    reauthDesc: '{connector} 凭证已过期。重新授权后将自动继续本次请求。',
    reauthAction: '授权 {connector}',
    reauthRetrying: '正在重跑…',
    newCliChat: '新建 CLI',
    ...
    modelSet: '模型已设置',
    modelFamilySwitchNotice: '切换模型系列后，历史推理上下文会重置，首条回复可能稍慢',
    ...
    workspaceDiffTitle: '工作区改动',
    workspaceDiffLoadFailed: '补丁加载失败',
  ...
  models: {
    ...
    capabilityVision: '视觉 — 可识别图片',
    capabilityReasoning: '推理 — 回答前会先思考',
    defaultModelTooltip: '当前 profile 的默认模型',
  ...
  settings: {
    ...
    display: {
      ...
      compact: '紧凑模式',
      compactHint: '减少消息间距',
      chatInputHeight: '输入框高度',
      chatInputHeightHint: '桌面端输入框高度（像素），移动端保持自适应。',
  ...
  files: {
    ...
    diffPatchEmpty: '本轮改动没有可显示的文本补丁（可能是二进制文件或重命名）',
    saveFile: '保存',
  },
  // 下载
  download: {
