...
vi.mock('../../packages/server/src/controllers/auth', () => ({
  ...
  feishuLogin: vi.fn(async (ctx: any) => { ctx.body = { ok: true } }),
  feishuCallback: vi.fn(async (ctx: any) => { ctx.body = { ok: true } }),
  feishuLogout: vi.fn(async (ctx: any) => { ctx.body = { ok: true } }),
  ...
  feishuUatStatus: vi.fn(async (ctx: any) => { ctx.body = { ok: true } }),
  feishuUatStart: vi.fn(async (ctx: any) => { ctx.body = { ok: true } }),
  feishuUatPoll: vi.fn(async (ctx: any) => { ctx.body = { ok: true } }),
  feishuUatCancel: vi.fn(async (ctx: any) => { ctx.body = { ok: true } }),
